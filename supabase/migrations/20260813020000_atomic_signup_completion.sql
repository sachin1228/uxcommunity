-- Complete all account-owned signup writes in one database transaction.
-- The application calls this RPC only after validating and moderating the full
-- four-step payload. It is intentionally unavailable to browser roles.
...
begin
  if nullif(btrim(p_name), '') is null
     ...
     or nullif(p_avatar_url, '') is null
     or nullif(p_avatar_source, '') is null then
