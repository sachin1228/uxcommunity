-- Home feed: community scope.
--
-- get_home_feed_page gains one optional argument:
--   p_member_only  when true the feed is restricted to communities the member
--                  belongs to ("Your Communities"); the default covers every
--                  public post ("For You").
