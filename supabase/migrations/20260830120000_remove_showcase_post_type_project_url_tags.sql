-- Remove post_type, project_url, and tags columns from community_showcase_posts
-- and update the showcase list RPC to match.
...
-- Recreate get_showcase_list_page without the dropped columns.
