...
export async function GET(
  ...
  const withReactions = await enrichCommentReactions(db, withUsers as Array<EnrichedRow & { id: string; created_at: string; parent_id: string | null }>, "thread_comment_id", session.userId!);
