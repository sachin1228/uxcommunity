export const communityFeedLayout = {
  ...
  card: "overflow-hidden rounded-xl border bg-muted border-border px-5 py-5 md:px-6",
  cardInteractive: "transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background",
  detailCard: "overflow-hidden rounded-xl border bg-muted border-border px-5 py-6 md:px-8",
  detailPage: "py-6",
  detailSection: "",
  sectionLabel: "",
  ...
  emptyIcon: "mb-4 text-muted-foreground",
  emptyTitle: "font-display text-base font-semibold text-foreground",
  emptyDescription: "mt-1 max-w-md text-pretty font-body text-sm leading-6 text-muted-foreground",
} as const;
