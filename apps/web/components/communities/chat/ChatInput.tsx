  ...
  function ChatInput(
    ...
    return (
      <div className="px-4 pb-4 shrink-0">
        ...
        {/* Image preview bar */}
        {pendingImagePreview && (
          <div className="flex items-center gap-2 mb-1 px-2 py-2 rounded-xl bg-popover">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
        ...
        {showLinkPreview && (
          <div className="relative mb-1">
            <div className="flex items-center gap-1.5 px-2 pt-1.5 pb-1">
              <Link strokeWidth={2.5} size={11} className="text-muted-foreground/60 shrink-0" />
        ...
        <div ref={anchorRef} className="relative">
          ...
          <div className="flex flex-col bg-popover rounded-2xl shadow-md px-[5px] pl-[5px] pr-[8px]">
            {/* Hidden file input */}
            <input
              ref={fileInputRef}
              type="file"
            ...
            {replyTo && (
              <div className="flex items-center gap-2 mt-2 mb-1 mx-2 border-l-2 rounded-md border-primary bg-[color-mix(in_srgb,var(--surface)_80%,transparent)]">
                <div className="flex-1 min-w-0 py-2 pl-2 rounded-sm">
                  <p className="font-body text-[11px] font-semibold text-primary truncate">
                    {replyTo.user_name}
                  </p>
