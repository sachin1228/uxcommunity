...
/**
 * The top line's size for the word it is given. The month abbreviation and
 * TODAY/LIVE are different lengths, so the word is trimmed to the circle's
 * inner width rather than allowed to bleed through the ring.
 */
