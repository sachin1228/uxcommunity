...
type Community = Pick<CachedSidebarCommunity, "last_message" | "joined_at" | "name">;

/**
 * The single sidebar ordering: most recent activity first, where activity is
 * the newest of (last message, join date). A freshly joined or created
 * community always floats to the top regardless of how old its last message
 * is. Ties fall back to the community name.
 *
